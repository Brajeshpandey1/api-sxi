package com.brajeshpandey.microservices.auth.config;
...
import com.brajeshpandey.microservices.auth.service.JdbcUserDetailsService;
...
public class OAuthServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	SecurityConfiguration security() {
		return new SecurityConfiguration(null, null, null, // realm Needed for authenticate button to work
				"user-service", // appName Needed for authenticate button to work
				"BEARER ", // apiKeyValue
